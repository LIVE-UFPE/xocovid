...
from App.models import UserProfileInfo, User, Notification, PredictionBR, InterpolationBR, PredictionPE, InterpolationPE, AccessKey, CasosEstado, CasosCidade, CasosEstadoHistorico, Projecao, CasosPernambuco
