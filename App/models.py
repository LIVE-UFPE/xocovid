...
class Notification(models.Model):      
    ...
    pais_residencia = models.CharField(max_length = 100, null=True)
    estado_residencia = models.CharField(max_length = 100, null=True)
    ...
    paciente_hospitalizado = models.CharField(max_length = 100, null=True)
    data_internacao = models.DateField(null=True)
    data_alta = models.DateField(null=True)
    data_isolamento = models.DateField(null=True)
    ventilacao_mecanica = models.CharField(max_length = 100, null=True)
    situacao_notificacao = models.CharField(max_length = 100, null=True)
    coleta_amostra = models.CharField(max_length = 100, null=True)
    foi_outro_local_transmissao = models.CharField(max_length = 100, null=True)
    outro_local_transmissao = models.CharField(max_length = 100, null=True)
    ...
    estado_notificacao = models.CharField(max_length = 100, null=True)
    municipio_notificacao = models.CharField(max_length = 100, null=True)
    coleta_exames = models.CharField(max_length = 100, null=True)
    classificacao = models.CharField(max_length = 100, null=True)
    resultado = models.CharField(max_length = 100, null=True)
    internado = models.CharField(max_length = 100, null=True)
    evolucao = models.CharField(max_length = 100, null=True)
