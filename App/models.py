...
class Notification(models.Model):      
    ...
    foi_outro_local_transmissao = models.CharField(max_length = 10, null=True)
    outro_local_transmissao = models.CharField(max_length = 20, null=True)
    ...
    estado_notificacao = models.CharField(max_length = 20, null=True)
    municipio_notificacao = models.CharField(max_length = 20, null=True)
